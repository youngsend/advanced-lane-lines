...
class Pipeline:
    ...
    def process(self, img):
        ...
        _, mask = self.threshold(undistorted)
        warped_mask = self.warp_img(mask)
        fitted = self.fit_polynomial(warped_mask)
        return undistorted, mask, warped_mask, fitted
    ...
    def fit_polynomial(self, binary_warped):
        ...
        left_fitx, right_fitx, ploty = self.get_poly_coordinates(binary_warped.shape, left_fit, right_fit)
